...
public record OrderItemRequest(Guid ProductId, int Quantity, decimal UnitPrice, string? Notes = null, List<OrderItemAddonRequest>? Addons = null, List<Guid>? FlavorProductIds = null, bool IsCrossSell = false);
